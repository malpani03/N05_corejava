...
public class StreamBasics {
	...
	public static void main(String[] args) {
		List<Integer> intList=Arrays.asList(4,7,2,9);
		System.out.println(intList);
		
		//create another list with square of intList
		...
		//spilt-up for line 23	
		Stream<Integer>intStream= intList.stream();
		intStream=intStream.sorted();
		intStream=intStream.map(no->no*no*no);
		...
		Student st=new Student(101,"Yash",67f);
		sList.add(st);
		st=new Student(102,"Suraj",97f);
		sList.add(st);
